...
# Skip certificate check - compatible with both PS 5.x and PS 6+
$SkipCert = @{}
...
Invoke-RestMethod -Uri "$BaseUrl/api/users" -Method Get @SkipCert | ConvertTo-Json -Depth 10
Write-Host ""
Read-Host "Press Enter to continue"

# Test 2: Get user by ID
Write-Host "Test 2: GET /api/users/$UserId (Get user by ID)" -ForegroundColor Yellow
Invoke-RestMethod -Uri "$BaseUrl/api/users/$UserId" -Method Get @SkipCert | ConvertTo-Json -Depth 10
Write-Host ""
Read-Host "Press Enter to continue"
...
Invoke-RestMethod -Uri "$BaseUrl/api/users/$UserId" -Method Patch -Body $body -ContentType "application/json" @SkipCert | ConvertTo-Json -Depth 10
Write-Host ""
...
Invoke-RestMethod -Uri "$BaseUrl/api/products" -Method Get @SkipCert | ConvertTo-Json -Depth 10
Write-Host ""
Read-Host "Press Enter to continue"
...
Invoke-RestMethod -Uri "$BaseUrl/api/products/$ProductId" -Method Patch -Body $body -ContentType "application/json" @SkipCert | ConvertTo-Json -Depth 10
Write-Host ""
